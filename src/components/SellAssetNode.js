...
export default function SellAssetNode({ data, id }) {
  const { holdings = [], onSellChange, onInputChange, onRemove, onAddChainedNode, savedInputs, isDisabled, onToggleDisabled, onShiftNode, canShiftLeft, canShiftRight } = data;
